...
namespace Andromeda {
    ...
    void GLFramebuffer::attachColorAttachments(GLenum textureTarget, const std::vector<FramebufferTextureSpecification>& colorSpecs)
    {
    ...
    void GLFramebuffer::attachDepthAttachment(bool isMultisampled, const FramebufferTextureSpecification& depthSpec, bool hasDepth)
    {
        if (!hasDepth) return;
    ...
    void GLFramebuffer::configureDrawBuffers()
    {
